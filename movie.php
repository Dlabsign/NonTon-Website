        ...
        <div class="container-sidebar">
            <div class="navTop" id="Logo">
                ...
                <ul class="nav-container">
                    ...
                    <button id="movieBtn" onclick="redirectMovie()" style="background-color:#4339F2;">
                        <object type="image/svg+xml" data="sidebar/img/icon/movie-after.svg"></object>
                        <a href="movie.php" id="txtButton" style="color:#fafafa;">Movie</a>
                    </button>
