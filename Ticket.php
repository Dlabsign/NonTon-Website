        ...
        <div class="container-sidebar">
            <div class="navTop" id="Logo">
                ...
                <ul class="nav-container" >
                    ...
                    <button id="ticketBtn" onclick="redirectTicket()" style="background-color:#4339F2;">
                        <object type="image/svg+xml" data="sidebar/img/icon/ticket-after.svg"></object>
                        <a href="ticket.php" style="color:#fafafa;" id="txtButton">Ticket</a>
                    </button>
